...
WxfbPrincipal::WxfbPrincipal( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	m_btn_buscar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickBuscar ), NULL, this );
	m_tabla->Connect( wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler( WxfbPrincipal::OnClickTabla ), NULL, this );
	m_btn_alta->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickAlta ), NULL, this );
	m_btn_editar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickEditar ), NULL, this );
	m_btn_baja->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickBaja ), NULL, this );
	m_btn_compra->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickCompra ), NULL, this );
	m_btn_venta->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickVenta ), NULL, this );
	m_btn_listados->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickListados ), NULL, this );
}

WxfbPrincipal::~WxfbPrincipal()
{
	// Disconnect Events
	m_btn_buscar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickBuscar ), NULL, this );
	m_tabla->Disconnect( wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler( WxfbPrincipal::OnClickTabla ), NULL, this );
	m_btn_alta->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickAlta ), NULL, this );
	m_btn_editar->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickEditar ), NULL, this );
	m_btn_baja->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickBaja ), NULL, this );
	m_btn_compra->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickCompra ), NULL, this );
	m_btn_venta->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickVenta ), NULL, this );
	m_btn_listados->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbPrincipal::OnClickListados ), NULL, this );
...
WxfbProducto::WxfbProducto( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	m_btn_cancelar_producto->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProducto::OnClickCancelarProducto ), NULL, this );
	m_btn_alta_producto->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProducto::OnClickAltaoEditarProducto ), NULL, this );
}

WxfbProducto::~WxfbProducto()
{
	// Disconnect Events
	m_btn_cancelar_producto->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProducto::OnClickCancelarProducto ), NULL, this );
	m_btn_alta_producto->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( WxfbProducto::OnClickAltaoEditarProducto ), NULL, this );

}

WxOperaciones::WxOperaciones( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
...
WxListados::WxListados( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticText13 = new wxStaticText( this, wxID_ANY, wxT("Listado de existencias por producto:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText14 = new wxStaticText( this, wxID_ANY, wxT("Listado de productos a reponer:"), wxDefaultPosition, wxDefaultSize, 0 );
